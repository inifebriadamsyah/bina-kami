...
export const FAQ = () => {
  ...
  return (
    <section className="bg-white md:overflow-x-clip sm:px-0">
      <div className="flex flex-col gap-10 md:w-full md:pb-20 md:pt-16 md:px-12 px- items-center text-center">
        <div className="pt-10">
          ...
          <h5 className="font-normal text-lg md:my-4 my-4 sm:mx-8 text-gray-700">
            Here you will find the answers to the frequently asked questions.
          </h5>
        </div>
        <div className="container flex md:grid md:grid-cols-1 mt-4 flex-col md:flex-row text-gray-700">
          {items.map(({ question, answer }) => (
            <AccordionItem question={question} answer={answer} key={question} />
          ))}
        </div>
        <div className="flex flex-col justify-center items-center md:w-5/12 mt-12 text-gray-600">
          <Image
            src={FAQPict}
            alt="faq pict"
            height={48}
